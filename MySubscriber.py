...
# 에러 시 멈추고, 사용자에게 전해주는 코드 작성하기.
        if target_busRouteId == "error":
            ...
            publish.single("eyeson/busTime",busFindStatus+uuid +"/" + busNum + "/" + arrival,hostname = "15.164.46.54") #데이터 전송
            ...
            publish.single("eyeson/busTime","bigData/ok/" + uuid + "/" + finalArrival,hostname = "15.164.46.54") #데이터 전송
            print(finalArrival)
            print(msgFinal)
